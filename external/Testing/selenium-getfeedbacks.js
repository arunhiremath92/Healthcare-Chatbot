...
async function getChatHistory(){
    ...
    await driver.wait(until.elementLocated(webdriver.By.id('View Feedbacks')), 15000);

    var button = driver.findElement(By.xpath("//button[@id='View Feedbacks']"));
        button.click();
    //driver.findElement(webdriver.By.id('View Feedbacks')).click();
